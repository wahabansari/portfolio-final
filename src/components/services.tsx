  ...
  return (
    <Section id="services" tone={tone}>
      <div className="grid gap-16 lg:grid-cols-[1fr_1.4fr] lg:gap-24">
        <div>
          <span className="ds-overline-accent mb-4 block">What I do</span>
          <h2 className="ds-h2">Frontend engineering, end to end</h2>
          <p className="body-large mt-6 max-w-md">
            One accountable engineer across build, rebuild and performance —
            with a wider service index for the work that surrounds it.
          </p>
...
export function ServicesList() {
  return (
    <Section tone="plain">
      <span className="ds-overline-accent mb-4 block">Services</span>
